...
public class SHA3 {
    // Para obtener el mensaje "digerido" con SHA-3 de 384 bits
    public static String getSHA384(String input){
        try {
            // Empleamos la función hash SHA-3 de tamaño 384 bits
    ...
    // Para obtener el mensaje "digerido" con SHA-3 de 512 bits
    public static String getSHA512(String input){

        try {
            // Empleamos la función hash SHA-3 de tamaño 512 bits
