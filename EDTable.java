...
public class EDTable {
    ...
    public static void printTable(String title){
        ...
        formateador.format("|%-20s|%20s|%20s|%20s|%20s|%n", "Vector", "ChaCha20 [ns]", "AES-EBC [ns]", "AES-CBC [ns]","RSA OAEP [ns]");
        ...
        for (EDRegistro registro : registros) {
            formateador.format("|%-20s|%20d|%20d|%20d|%20d|%n", registro.vector, registro.timeChacha20, registro.timeAESECB, registro.timeAESCBC,registro.timeRSA_OAEP);
        }
